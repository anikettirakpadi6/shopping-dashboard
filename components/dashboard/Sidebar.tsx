      ...
      >
        ...
        {showLogoutModal && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="w-full max-w-sm mx-auto rounded-2xl bg-white dark:bg-slate-900 shadow-2xl p-6">
              ...
              <div className="flex gap-3 mt-6">
                <button
                  ...
                  className="flex-1 py-2 rounded-xl border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800"
                >
                  Cancel
                </button>
